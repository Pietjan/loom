// Module tools exists only to pin the command-line tools the repo builds with,
// keeping their dependencies out of the library and the site. Nothing imports
// it and it ships no code.
module github.com/pietjan/loom/tools
